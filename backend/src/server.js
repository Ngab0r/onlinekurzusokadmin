...
app.use('/attachments', authenticateJwt, require('./controllers/attachment/attachment.routes'));
app.use('/payments', authenticateJwt, adminOnly, require('./controllers/payment/payment.routes'));
